...
const INGREDIENTS_DB = [
    ...
    },
    {
        ...
        cons: '植物蛋白並非完全不能吃,但對肉食性的貓而言<strong>動物蛋白的氨基酸譜更完整、吸收率更高</strong>。植物分離蛋白常被用來「撐高粗蛋白 %」、降低成本,實際對貓的營養貢獻不如同等比例的動物蛋白。'
    },
    {
        name: '水解酵母',
    ...
    {
        name: '白米',
        aliases: ['白米', '米飯', '米麩質', '米麩', '米糠', '米', 'rice', 'rice bran'],
        level: 'neutral', function: 'carb', category: '碳水化合物',
        pros: '易消化、低過敏,常作為腸胃處方主食。',
        cons: '貓是肉食動物,本身沒有專門消化大量碳水的酵素,前位出現代表蛋白比例可能偏低。「米麩質」「米糠」等是米的副產物,主要是碳水/纖維,並非優質蛋白。'
    },
    {
        name: '玉米',
    ...
    },
    {
        ...
        cons: '貓對植物蛋白的吸收率不如動物蛋白,且大豆是常見過敏原,含植酸會影響礦物質吸收。注意:若標示為「大豆卵磷脂」「大豆油」則為其他成分,並非大豆蛋白本身。'
    },
    {
        name: '馬鈴薯',
    ...
    },
    {
        ...
        pros: '無穀配方常見成分,提供纖維與植物蛋白。豌豆本身不是「不能吃」。',
        cons: '對肉食性的貓而言,<strong>動物蛋白的氨基酸譜更完整、吸收率更高</strong>。<br>⚠️ <strong>「拆名字」陷阱</strong>:標籤常把「豌豆蛋白、豌豆纖維、豌豆澱粉」分開列在不同位置,讓肉看起來排前面,但加總後豆類占比可能很高。<br>📌 FDA 也已調查豆類過量可能與貓犬擴張型心肌病(DCM)有關聯。'
    },
    {
        name: '木薯',
